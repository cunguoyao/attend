...
import com.linkage.study.attend.widget.ptr.recyclerview.RecyclerAdapterWithHF;
...
public class RecyclerViewHandler implements LoadMoreHandler {
    ...
    public boolean handleSetAdapter(View contentView, ILoadMoreViewFactory.ILoadMoreView loadMoreView, OnClickListener onClickLoadMoreListener) {
        ...
        if(recyclerView instanceof SwipeMenuRecyclerView) {
            mRecyclerAdapter = (RecyclerAdapterWithHF) ((SwipeMenuRecyclerView)recyclerView).getOriginAdapter();
        }else {
