 ...
 * SwipeRefreshLayout + RecyclerView（不带侧滑菜单的）
 */
public class MySwipeRecyclerView extends FrameLayout
    ...
    private void setupSwipeRecyclerView() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.swipe_layout_swipe_recyclerview, this);
