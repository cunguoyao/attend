...
package com.linkage.study.attend.widget.cascade;
...
import com.linkage.study.attend.widget.cascade.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xFFf0efed,
			0x00f0efed, 0x00f0efed };
