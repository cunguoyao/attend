...
import com.linkage.study.attend.widget.swipe.SwipeMenuRecyclerView;

/**
 * @auther Yao
 * @time   2017/09/24
 * 所有列表用MySwipeRecyclerView和MySwipeMenuRecyclerView这2个就够了
 * SwipeRefreshLayout + SwipeMenuRecyclerView（带侧滑菜单的）
 */
public class MySwipeMenuRecyclerView extends FrameLayout
    ...
    public MySwipeMenuRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySwipeMenuRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void setupSwipeRecyclerView() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.swipe_layout_swipe_menu_recyclerview, this);
